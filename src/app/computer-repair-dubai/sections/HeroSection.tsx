  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-96 h-96 bg-red-500/20 rounded-full blur-3xl -bottom-48 -right-48 animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-6">
            ...
            <span className="text-sm text-orange-300">Dell & HP Certified Technicians</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Same-day repairs • Dell & HP certified • 90-day warranty • Free diagnostics
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group px-8 py-4 rounded-xl bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/40 transition-all duration-300 flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { icon: CheckCircleIcon, text: '5000+ Devices Repaired', color: 'text-green-400' },
              { icon: ShieldCheckIcon, text: 'Dell & HP Certified', color: 'text-orange-400' },
              { icon: ClockIcon, text: 'Same-Day Service', color: 'text-red-400' },
              { icon: StarIcon, text: '90-Day Warranty', color: 'text-yellow-400' },
            ].map((item, idx) => (
              <motion.div
                key={idx}
