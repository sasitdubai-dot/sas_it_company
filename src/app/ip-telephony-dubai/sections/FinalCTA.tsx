        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 mb-6">
              ...
              <span className="text-sm text-green-300 font-medium">Free Demo Available</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Get a free phone system demo and consultation. See how modern IP telephony can transform your business communication.
            </p>

            <div className="space-y-4 mb-8">
              {[
                'Free on-site demo & consultation',
          ...
          >
            <div className="p-8 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Book Free Demo</h3>
