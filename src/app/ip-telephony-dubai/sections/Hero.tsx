...
import { PhoneIcon, ShieldCheckIcon, CheckCircleIcon, ClockIcon, StarIcon } from '@heroicons/react/24/outline';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
            ...
            <span className="text-sm text-blue-300">Yeastar & Grandstream Certified</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Professional IP Phone<br />
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Yeastar certified • Cloud PBX • Mobile integration • Free demo
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { icon: CheckCircleIcon, text: '300+ Systems Deployed', color: 'text-green-400' },
              { icon: ShieldCheckIcon, text: 'Yeastar Certified', color: 'text-blue-400' },
              { icon: ClockIcon, text: '24/7 Support', color: 'text-purple-400' },
              { icon: StarIcon, text: '3-Year Warranty', color: 'text-yellow-400' },
            ].map((item, idx) => (
              <motion.div
                key={idx}
