...
import { PhoneIcon, ShieldCheckIcon, CheckCircleIcon, ClockIcon, StarIcon, VideoCameraIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-96 h-96 bg-purple-500/30 rounded-full blur-3xl -bottom-48 -right-48 animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
            ...
            <span className="text-sm text-blue-300">Logitech Certified Partner</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Professional AV systems for seamless collaboration and video conferencing
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { icon: CheckCircleIcon, text: '150+ Rooms Installed', color: 'text-green-400' },
              { icon: ShieldCheckIcon, text: 'Logitech Certified', color: 'text-blue-400' },
              { icon: VideoCameraIcon, text: 'Teams & Zoom Certified', color: 'text-purple-400' },
              { icon: ClockIcon, text: '24/7 Support', color: 'text-yellow-400' },
            ].map((item, idx) => (
              <motion.div
                key={idx}
